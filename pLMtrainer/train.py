...
config = {
    "experiment_name": "it5_ABL_protT5_CW_LORA",
    ...
    "ce_weighting": [2.65750085, 0.68876299, 0.8533673], #[10.0, 2.0, 2.5], [(1/0.13)/(1/0.13), (1/0.48)/(1/0.13), (1/0.39)/(1/0.13)]
    "notes": "sklearn compute class weights function",
}
architecture = {}
...
trainer = Trainer(default_root_dir=f"./{config['experiment_name']}",
                accelerator="gpu",
                devices=4,
                strategy=DDPStrategy(find_unused_parameters=find_unused), # true bc of finetune
                max_epochs=20,
                logger=logger,
